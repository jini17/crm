...
include_once 'include/Webservices/Utils.php';
	...
	$MODULENAME = 'Grade'; //Give your module name
	$PARENT 	= 'Support';  //Give Parent name
	$ENTITYNAME = 'grade'; //Give Duplicate check field name
	$ENTITYLABEL= 'Grade';
	...
	$block->label = 'LBL_Grade_Information';
	...
	$field5->name = 'grade_status';
	$field5->label = 'Grade Status';
	$field5->table = $module->basetable;
	$field5->column = 'grade_status';
	$field5->columntype = 'VARCHAR(1)';
	$field5->uitype = 56;
	...
	$field16->name   =  'grade_desc';
	$field16->label  = 'Description';
	$field16->table  =  $module->basetable;
	$field16->column = 'grade_desc';
	$field16->columntype = 'TEXT';
	$field16->uitype	= 19;
	$field16->typeofdata = 'V~O'; // varchar~Mandatory
