...
class Google_Config
{
  ...
  public function __construct($ini_file_location = null)
  {
    $this->configuration = array(
      ...
      // Which Authentication classes to use.
      'auth_class'    => 'Office365_Auth_OAuth2',

      // Don't change these unless you're working against a special development
      // or testing environment.
      'base_path' => 'https://outlook.office.com',
  ...
  {
    $prev = $this->configuration['token'];
    if (!isset($this->configuration['classes'][$token]) &&
        isset($this->configuration['classes'][$prev])) {
      $this->configuration['classes'][$token] =
          $this->configuration['classes'][$prev];
    }
