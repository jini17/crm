...
include_once 'include/Webservices/Utils.php';
	...
	$MODULENAME = 'EmployeeProjects'; //Give your module name
	$PARENT 	= 'Support';  //Give Parent name
	$ENTITYNAME = 'project_title'; //Give Duplicate check field name
	...
	$block->label = 'LBL_Employee_Project_Information';
	...
	$field6->name   =  'project_url';
	$field6->label  = 'Project URL';
	$field6->table  =  $module->basetable;
	$field6->column = 'project_url';
	...
	$field7->name   =  'ispublic';
	$field7->label  = 'Do you want to make it Public ?';
	$field7->table  =  $module->basetable;
	$field7->column = 'ispublic';
	...
	$field8->name   =  'project_description';
	$field8->label  = 'Description';
	$field8->table  =  $module->basetable;
	$field8->column = 'project_description';
