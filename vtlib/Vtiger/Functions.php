...
class Vtiger_Functions {
	...
	require_once 'testAPI/vendor/autoload.php';
	 ...
	 $client->setAuthConfig('testAPI/client_secret.json');
	 $client->setAccessType('offline');

	 $accessToken = json_decode(file_get_contents('testAPI/drive-php-quickstart.json'), true);
