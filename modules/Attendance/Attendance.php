...
class Attendance extends Vtiger_CRMEntity {
	...
	var $list_link_field = 'attendanceno';
	...
	var $popup_fields = Array ('attendanceno');

	// For Alphabetical search
	var $def_basicsearch_col = 'attendanceno';

	// Column value to use on detail view record text display
	var $def_detailview_recname = 'attendanceno';

	// Used when enabling/disabling the mandatory fields for the module.
	// Refers to vtiger_field.fieldname values.
	var $mandatory_fields = Array('attendanceno','assigned_user_id');

	var $default_order_by = 'attendanceno';
