...
class Vtiger_InvoicePDFController extends Vtiger_InventoryPDFController{
	...
	function buildSummaryModel() {
		...
		$summaryModel->set(getTranslatedString("Total ", $this->moduleName)."($currencySymbol)", $grandtotal); 
		//end here
	//$summaryModel->set(getTranslatedString("Grand Total", $this->moduleName)."($currencySymbol)", $this->formatPrice($final_details['grandTotal'])); // TODO add currency string
