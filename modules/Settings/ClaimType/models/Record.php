	...
	public function getRecordLinks() {
		...
		$recordLinks = array(
			array(
				...
				'linklabel' => 'LBL_EDIT',
				'linkurl' => 'javascript:Settings_ClaimType_List_Js.triggerEdit(event)',
				'linkicon' => 'icon-pencil'
			),
			array(
				'linktype' => 'LISTVIEWRECORD',
				'linklabel' => 'LBL_DELETE',
				'linkurl' => "javascript:Settings_ClaimType_List_Js.triggerDelete('".$this->getDeleteActionUrl()."')",
				'linkicon' => 'icon-trash'
			)
		);
