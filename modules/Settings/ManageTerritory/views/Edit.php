...
*
 *************************************************************************************************************************************/
class Settings_ManageTerritory_Edit_View extends Settings_Vtiger_Index_View {
	...
	public function process(Vtiger_Request $request) { 
		...
		if(!empty($record)) {
			...
			$recordModel = new Settings_ManageTerritory_Record_Model();
			$viewer->assign('MODE', 'create');

		}
		
		//NEW
		$rootRegion = Settings_ManageTerritory_Record_Model::getBaseRegion($record);
