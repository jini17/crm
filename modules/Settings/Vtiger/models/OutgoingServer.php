...
class Settings_Vtiger_OutgoingServer_Model extends Settings_Vtiger_Systems_Model {
    ...
    public function getBody() {
        ...
        return 'Dear '.$currentUser->get('user_name').', <br><br><b> This is a test mail sent to confirm if a mail is 
                ...
                <br><br>Thanks  and  Regards,<br> Team Second CRM <br><br>';
    }
	...
	public function getNewViewUrl() {
		$menuItem = $this->getMenuItem();
		return '?module=Vtiger&parent=Settings&view=OutgoingServerNew&block='.$menuItem->get('blockid').'&fieldid='.$menuItem->get('fieldid');
	}
    ...
    public function save($request){  
        ...
        $from_email =  $array['from_email_field'];
	    ...
	    //Added by jitu@19062015 for making defaultloaded true	
  		    $this->defaultLoaded = true;
	    //End here
        }
        //print_r($mail_status);
		$_REQUEST['action'] = $olderAction;
        if($mail_status != 1 && !$this->defaultLoaded) {
