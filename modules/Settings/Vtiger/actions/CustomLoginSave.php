...
class Settings_Vtiger_CustomLoginSave_Action extends Settings_Vtiger_Basic_Action {
	...
	$status = false;	
        ...
        if ($request->get('id')) {
			...
			if(!empty($_FILES['logo']['name'])) {
                ...
                if (!$logoDetails['size'] || !in_array($fileType, Settings_Vtiger_CustomLogin_Model::$logoSupportedFormats)) {
                    $saveLogo = false;
                }
