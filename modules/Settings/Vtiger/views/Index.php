...
class Settings_Vtiger_Index_View extends Vtiger_Basic_View {
        ...
        function checkPermission(Vtiger_Request $request) {
                ...
                if(!$currentUserModel->isAdminUser() && !in_array($currentUserModel->get('roleid'), array('H2','H12','H13'))) {
        ...
        public function preProcessSettings (Vtiger_Request $request ,$display=true) {
                ...
                $usersidebar        = $currentUser->UserSidebarPermission($currentUser,$request); // Params $modulename, UserInstance
                ...
                $viewer->assign('FILTERVIEW',$usersidebar['filterview']);
                 $viewer->assign('ADMINVIEW',$usersidebar['adminview']);
                 $viewer->assign('USERVIEW',$usersidebar['userview']);
 ...
 if($moduleName == 'Users' && $_GET['view'] == 'List'){
                                $filterview = "hide filterview";
                            }
                            else{
                                $filterview = "filterview";
                            }
              $viewer->assign('FILTERVIEW',$filterview);
