...
class Settings_Vtiger_FullContactConfigDetail_View extends Settings_Vtiger_Index_View {
	...
	public function process(Vtiger_Request $request) {
		...
		$viewer->view('FullContactConfigDetail.tpl', $qualifiedName);
	}
	
	function getPageTitle(Vtiger_Request $request) {
		$qualifiedModuleName = $request->getModule(false);
		return vtranslate('LBL_FULLCONTACT_CONFIG',$qualifiedModuleName);
	}
