...
class Users_Field_Model extends Vtiger_Field_Model {
	...
	public function isReadOnly() {
		...
		if(($currentUserModel->isAdminUser() == false && $this->get('uitype') == 98 && !in_array($currentUserModel->roleid, array('H2','H12','H13'))) || $this->get('uitype') == 106 || $this->get('uitype') == 156 || $this->get('uitype') == 115) {
			return true;
		}
	}
