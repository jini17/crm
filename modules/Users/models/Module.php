...
class Users_Module_Model extends Vtiger_Module_Model {
	...
	*/
	 ...
	 * @param type $username
	 * @modified by jitu@10-04-2015 for saving broswers type 
	 */
	public function saveLoginHistory($username, $status = 'Signed in', $browser = '',$userIPAddress){ 	//add one more param userIPAddress by jitu@28Dec2016 
	...
	**/
	public function ValidateUserSubscription($username, $role){
