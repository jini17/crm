...
class LanguageSkill extends Vtiger_CRMEntity {
	...
	var $popup_fields = Array ('serialno');

	// For Alphabetical search
	var $def_basicsearch_col = 'serialno';

	// Column value to use on detail view record text display
	var $def_detailview_recname = 'serialno';

	// Used when enabling/disabling the mandatory fields for the module.
	// Refers to vtiger_field.fieldname values.
	var $mandatory_fields = Array('serialno','assigned_user_id');

	var $default_order_by = 'serialno';
