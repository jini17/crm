...
class ExitInterView extends Vtiger_CRMEntity {
	...
	var $list_fields = Array (
		...
		'LBL_EMPLOYEE' => Array('exitinterview', 'employee_id'),
	...
	var $popup_fields = Array ('employee');

	// For Alphabetical search
	var $def_basicsearch_col = 'employee';

	// Column value to use on detail view record text display
	var $def_detailview_recname = 'employee';

	// Used when enabling/disabling the mandatory fields for the module.
	// Refers to vtiger_field.fieldname values.
	var $mandatory_fields = Array('employee','assigned_user_id');

	var $default_order_by = 'employee';
