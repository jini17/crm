...
class Payments extends Vtiger_CRMEntity {
	...
	var $list_fields = Array (
		...
		'Payment Ref' => Array('payments', 'paymentref'),
	...
	var $popup_fields = Array ('paymentref');

	// For Alphabetical search
	var $def_basicsearch_col = 'paymentref';

	// Column value to use on detail view record text display
	var $def_detailview_recname = 'paymentref';

	// Used when enabling/disabling the mandatory fields for the module.
	// Refers to vtiger_field.fieldname values.
	var $mandatory_fields = Array('paymentref','assigned_user_id');

	var $default_order_by = 'paymentref';
