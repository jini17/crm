...
class Vtiger_Record_Model extends Vtiger_Base_Model {
	...
	public function getDetailViewUrl() {
		...
		if($_REQUEST['parentmodule']=='Settings' && ($this->getModuleName() =='WorkingHours' || $this->getModuleName() =='EmployeeContract' || $this->getModuleName()=='PassportVisa' || $this->getModuleName()=='Performance' || $this->getModuleName()=='Grade' || ($this->getModuleName()=='Documents' && $_REQUEST['parent']=='Settings') || $this->getModuleName()=='Payslip'|| $this->getModuleName() =='Claim')){
