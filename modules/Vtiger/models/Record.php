...
class Vtiger_Record_Model extends Vtiger_Base_Model {
	...
	public function getDetailViewUrl() {
		...
		if($_REQUEST['parentmodule']=='Settings' && ($this->getModuleName() =='EmployeeContract' || $this->getModuleName()=='PassportVisa' || $this->getModuleName()=='Performance' || $this->getModuleName()=='Grade' || $this->getModuleName()=='Documents')){
