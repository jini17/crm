...
class Vtiger_Field_Model extends Vtiger_Field {
	...
	public function getWebserviceFieldObject() {
		if($this->webserviceField == false) {
			...
			$row['iscustom'] = $this->get('iscustom'); //added by jitu@CustomField
	...
	*/
	...
	public function getFileLocationType() {
		//'G' => LBL_GOOGLE Added By Mabruk for Google Drive API Integration 26/03/2018
		
		$fileLocationType = array('I'=> vtranslate('LBL_INTERNAL','Documents'), 'E'=> vtranslate('LBL_EXTERNAL','Documents'),
					 'G'=> vtranslate('LBL_GOOGLE','Documents'));
		//Added By Mabruk 29/03/2018
		if ($_SESSION['plan'] == 'Foundation'){
					unset($fileLocationType['I']);
					unset($fileLocationType['E']);
		}		
	...
	public function updateTypeofDataFromMandatory($mandatoryValue='O') {
		...
		//Modified by jitu@CustomField
    public function isCustomField() {
    	return $this->get('iscustom')==1 ? true : false;
    } //end here
