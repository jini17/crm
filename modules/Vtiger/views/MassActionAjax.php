...
class Vtiger_MassActionAjax_View extends Vtiger_IndexAjax_View {
	...
	function showSendSMSForm(Vtiger_Request $request) {
		...
		//Added By Mabruk on 09/04/2018 for Multiple SMS Vendors Integration
		$viewer->assign('VENDORS',Settings_Workflows_Record_Model::getActiveSMSvendors()); 
		$viewer->assign('TEMPLATES',Settings_Workflows_Record_Model::getSMSTemplates()); //Added By Mabruk
