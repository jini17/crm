...
abstract class Vtiger_Basic_View extends Vtiger_Footer_View {
        ...
        function preProcess (Vtiger_Request $request, $display=true) {
                ...
                $viewer->assign('SALES_MENU',$companyLogo);
                $viewer->assign('SUPPORT_MENU',$companyLogo);
        ...
        public function validateRequest(Vtiger_Request $request) {
                ...
                $allowedViews = array("List", "Index", "Detail", "PreferenceDetail", "CompanyDetails", "TaxIndex", "OutgoingServerDetail",
