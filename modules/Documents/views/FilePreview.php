...
class Documents_FilePreview_View extends Vtiger_IndexAjax_View {
	...
	public function process(Vtiger_Request $request) {
		...
		//Added By Jitu/Mabruk for Google Drive Integration 28/03/2018
		else {
			$downloadUrl =  'index.php?module=Documents&action=DownloadFile&record='.$recordId.'&fileid='.$fileDetails['attachmentsid'];
		}
		//End
