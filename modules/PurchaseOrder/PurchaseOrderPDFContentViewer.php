 ...
 ************************************************************************************/
	...
	class PurchaseOrderPDFContentViewer extends Vtiger_PDF_InventoryContentViewer {
			...
			foreach($summaryCellKeys as $key) {
				...
				if(!empty($keyvalue) && $keyvalue !='0.00') {
					...
					if($key == 'Discount') {
						...
						$summaryhtml .= '<tr><td colspan="3" width="170pt"  bgcolor='.$bgcolortotal.'><strong>'.$key.':</strong></td>	
						<td align="right" width="100pt"  bgcolor='.$bgcolortotal.'>'.$keyvalue.'</td>
						</tr>';
					}
				}
