...
class Office365_Contacts_Controller extends WSAPP_SynchronizeController {

    /**
     * Returns the connector of the Office365 contacts
     * @return Office365_Contacts_Connector
     */
    public function getTargetConnector() {
        $oauth2Connector = new Office365_Oauth2_Connector($this->getSourceType(),$this->user->id); 
        $oauth2Connection = $oauth2Connector->authorize(); 
        $connector = new Office365_Contacts_Connector($oauth2Connection); 
