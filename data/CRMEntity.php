...
class CRMEntity {
	...
	function uploadAndSaveFile($id, $module, $file_details, $attachmentType='Attachment',$fileLocationType=null) {
		...
		// Parameter $fileLocationType Added by Mabruk for Goolge Drive Integration 27/03/2018
		$upload_file_path = decideFilePath($fileLocationType);

		// Edit By Mabruk for Goolge Drive Integration 27/03/2018
		if ($fileLocationType == 'I' || $fileLocationType ==null){
	    	...
	    	'parents'=>array($upload_file_path),
	    	'name' => $file_details['name']));
			$content = file_get_contents($file_details['tmp_name']);
	 		$file = $service->files->create($fileMetadata, array(
	    	'data' => $content,
	    	'mimeType' => $file_details['type'],
	    	'uploadType' => 'multipart',
	    	'fields' => 'id'));		
	 		$upload_file_path = $file->id;
	 		$upload_status = 'true';
		}
		//Edit End - Mabruk
