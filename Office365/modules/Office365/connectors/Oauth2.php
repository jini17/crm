...
class Outlook_Oauth2_Connector {
    ...
    protected $scopes = array(
        'Contacts' => 'https://outlook.office.com/contacts.readwrite',
        'Calendar' => 'https://outlook.office.com/calendars.readwrite',
    );
    ...
    public function __construct($module,$userId=false) {
		...
		$this->client_id = Outlook_Config_Connector::$clientId;
		$this->client_secret = Outlook_Config_Connector::$clientSecret;
		$this->redirect_uri = Outlook_Config_Connector::getRedirectUrl();
   ...
   /* public function getApprovalPrompt() {
    ...
    public function getState($source) {
        global $site_URL;
        $callbackUri = rtrim($site_URL, '/') . '/index.php?module=Outlook&view=List&operation=sync&sourcemodule='.$this->source_module . '&service=' . $source;
