                         ...
                         <div class="form-group">
                            ...
                            <div class="controls fieldValue col-lg-4 col-md-4 col-sm-4" >
                               <select class="select2 inputElement col-lg-12" id="planFilter" name="plantitle">
                                    ...
                                    <option value="Sales" {if $PLAN eq 'Sales'}selected{/if}>{vtranslate('Sales', $QUALIFIED_MODULE)}</option>
                                    <option value="Support" {if $PLAN eq 'Support'}selected{/if}>{vtranslate('Support', $QUALIFIED_MODULE)}</option>
                                    <option value="Enterprise" {if $PLAN eq 'Enterprise'}selected{/if}>{vtranslate('Enterprise', $QUALIFIED_MODULE)}</option>
                                    <option value="Sales+Support" {if $PLAN eq 'Sales+Support'}selected{/if}>{vtranslate('Sales+Support', $QUALIFIED_MODULE)}</option>
                                </select>
                            </div>
                        </div>
                        <div class="form-group">
