 ...
 * All Rights Reserved.
 *************************************************************************************************************************************/
jQuery.Class('Settings_ManageTerritory_Edit_Js', {
	...
	deleteItemEvent : function(node) {
		...
		app.showModalWindow(null, "index.php?module=ManageTerritory&parent=Settings&view=ReplaceTreeItem", function(wizardContainer){
