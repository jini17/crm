...
Vtiger.Class("Settings_Vtiger_BenefitType_Js",{},{
    ...
    registerDeleteButton : function() {
        ...
        jQuery("#deleteItem").click(function () {
            ...
            var params = {
                ...
                'view' : 'BenefitTypeTools',
                'values' : selectedvalues,
                'mode'  : 'DeleteBenefitType'
            }

            AppConnector.request(params).then(
                function() {
                    var url = "?module=Vtiger&parent=Settings&view=BenefitTypeListView&block=14&fieldid=51";
    ...
    saveRule: function(){
        ...
        jQuery(document).ready(function () {
            ...
            jQuery(document).on('click', "#saveButtonRule", function () {
                ...
                if(jQuery("#EditBenefitTypeContainer").length >0){
                    mode = 'UpdateBenefitType'
                }else{
                    mode = 'AddBenefitType';
                }
