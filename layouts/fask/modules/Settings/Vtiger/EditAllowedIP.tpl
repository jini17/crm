...
{strip}
    ...
    <div class="taxModalContainer modal-dialog modal-xs" id="EditAllowedIPContainer">
        <div class="modal-content">
            <form id="AddRule" class="form-horizontal" method="POST">
                <div class="modal-body" id="scrollContainer" name="test">
                    <div class="container float-left">
                        <div class="contents row form-group">
                            ...
                            <div class="col-lg-4 col-md-4">
                                <input type="text" placeholder="192.0.0.0" id="ipval" name="ipval" value="{$VALUES['ip']}">
                            </div>
                        </div>
                    </div>
                    <div class="container float-left">
                    ...
                    <div class="container float-left">
                        ...
                        <div class="contents row form-group">
                            ...
                            <div class="fieldValue col-lg-4 col-md-4 col-sm-4 ">
                                {if {$VALUES['iprestriction_type']} eq 'allowed'}
                                <input type="radio" name="iprestriction_type" value="allowed" checked = 'checked'/> Allowed<br>
                                ...
                                <input type="radio" name="iprestriction_type" value="notallowed" checked = 'checked'/> Not Allowed<br>
                                {/if}
                            </div>
                        </div>
                    </div>
                ...
                <input type="hidden" id="ip_id" name="ip_id" value="{$VALUES['ip_id']}">
                </div>
