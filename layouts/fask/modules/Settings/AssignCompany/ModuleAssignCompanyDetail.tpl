<div class="row-fluid layoutContent col-md-12" style="margin-bottom: 15px;">
	...
	<div class="row-fluid col-md-6" style="margin-bottom: 15px;">
		<div><i class="fa fa-info-circle"></i>&nbsp;&nbsp;<span class="selectedCell padding1per">{vtranslate('LBL_SELECTED_VALUES',$QUALIFIED_MODULE)}</span>&nbsp;<span>{vtranslate('LBL_SELECTED_VALUES_MESSGAE',$QUALIFIED_MODULE)}</span></div><br>
		<div><i class="fa fa-info-circle"></i>&nbsp;&nbsp;<span>{vtranslate('LBL_ENABLE/DISABLE_MESSGAE',$QUALIFIED_MODULE)}</span></div><br>
		&nbsp;&nbsp;
	</div>
