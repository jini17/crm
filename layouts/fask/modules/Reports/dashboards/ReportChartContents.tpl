 ...
 $(document).ready(function(){
      ...
      for(var i = 0; i < data.links.length ; i++){
         ...
         for(var i = 0; i < data.labels.length ; i++){
                 ...
                 value.push( data.values[i]) ;
                var header = { 'label':  data.labels[i]}
                objlable.push(header)
    ...
    var plot1 = $.jqplot("widgetChartContainer_{$WIDGET->get('id')}", [s1], {
       ...
       {* Vtiger_Barchat_Widget_Js('Vtiger_Reportchart_Widget_Js',{},{
                ...
                getPlotContainer : function(useCache) {
                        ...
                        console.log('#widgetChartContainer_'+widgetid);
...
$(document).ready(function(){
    ...
    // from their vertical bar counterpart.
      ...
      for(var i = 0; i < data.links.length ; i++){
        ...
        console.log(data)
    var plot2 =  $.jqplot("widgetChartContainer_{$WIDGET->get('id')}", chartData, {
        seriesDefaults: {
            renderer:$.jqplot.BarRenderer,
