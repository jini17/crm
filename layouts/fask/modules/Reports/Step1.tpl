...
<div class="reportContents">
    <form class="form-horizontal recordEditView" id="report_step1" method="post" action="index.php">
        ...
        <div style="border:1px solid #ccc;padding:4%;">
            ...
            <div class="row">
                <div class="form-group">
                    <label class="col-lg-3 control-label textAlignLeft">{vtranslate('LBL_SELECT_RELATED_MODULES',$MODULE)}&nbsp;({vtranslate('LBL_MAX',$MODULE)}&nbsp;<span id="modulecount">2</span>)</label>
