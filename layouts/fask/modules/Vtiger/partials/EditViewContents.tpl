                            ...
                            <div class='fieldBlockContainer' style="height: auto">
                                        ...
                                        <div class="table table-borderless">
                                                ...
                                                {if $BLOCK_LABEL eq 'Participants' && $MODULE eq 'Events'}
                                                        <div class="row">
                                                                <div class="fieldLabel alignMiddle col-md-2">{vtranslate('LBL_INVITE_USERS', $MODULE)}</div>
                                                                <div class="fieldValue col-md-3">
                                                                        <select id="selectedUsers" class="select2 inputElement" multiple name="selectedusers[]" style='width:100%'>
                                                                ...
                                                                <div class="fieldLabel alignMiddle col-md-2">{vtranslate('LBL_INVITE_EXTERNAL_EMAILS', $MODULE)}</div>
                                                                <div class="fieldValue alignMiddle  col-md-3">
                                                                ...
                                                                <div class="visible-sm visible-xs clearfix"></div>
                                                                <div></div>
                                                                  <span class="addemail" style="cursor:pointer;">
                                                                            <button class="btn btn-primary" style="margin-right:-30%; margin-top;margin-top: -3px;"  name="addemail">
                                                                                <i class="fa fa-plus"></i>&nbsp;Add Email</button>
                                                                        </span>
                                                                        <span class="fieldvalue inputspan hide">
                                                                            <input type="email" class="inputElement" name="extemail" id="extemail" />
                                                                        </span>
