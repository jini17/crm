...
<style>
  ...
  .searchoption  .select2-container .select2-choice .select2-arrow b{
    display: none;
  }
  .searchoption   .select2-container .select2-choice .select2-arrow {
    {
  ...
  .searchoption .select2-container .select2-choice {
    height: 41px;
    /* Jobsy form controls have 37px total height */
...
<nav class="navbar navbar-default navbar-fixed-top app-fixed-navbar">
  ...
  <div class="headertext" id="headertextflow"> {if !empty($announcement)}{$announcement}{else}{vtranslate('LBL_NO_ANNOUNCEMENTS',$MODULE)}{/if}
  </div>
      ...
      <div class='col-md-6 col-sm-12 col-xs-12'>
        <div id="appnavigator" class="col-lg-2 col-md-2 col-sm-2 col-xs-2 cursorPointer app-switcher-container hidden-lg hidden-md " data-app-class="{if $MODULE eq 'Home' || !$MODULE}ti-dashboard{else}{$APP_IMAGE_MAP[$SELECTED_MENU_CATEGORY]}{/if}">
          <div class="row app-navigator">
            <span class="app-icon fa fa-bars">
            </span>
          </div>
        </div>
        <!-- nuovo menu-->  
            ...
            <ul class="faskfirst">
              ...
              <li class="{if $MODULE eq "Home"}active{/if}"> 
                <a class=" waves-effect waves-dark" href="{$HOME_MODULE_MODEL->getDefaultUrl()}" >
                  ...
                  <span class="hide-menu" style="text-transform: uppercase">{vtranslate('LBL_DASHBOARD',$MODULE)} 
                  </span>
                </a>
              </li>
              {/if}
              ...
              <li class="{if $MODULE eq "Documents"}active{/if}"> 
                <a class=" waves-effect waves-dark" href="index.php?module=Documents&view=List" >
                  <i class="app-icon-list material-icons">insert_drive_file
                  </i>
              ...
              <li tools="">
                <a class="waves-effect waves-dark " href=" index.php?module=RecycleBin&amp;view=List&amp;app=TOOLS ">
                  <i class="material-icons module-icon">delete_forever
                  </i> 
                  <span class="hide-menu"> Recycle Bin
                  </span>
                </a>
              </li>
              <li foundation="">
            ...
            <ul class="fasksecond">
              ...
              <li {$APP_NAME} class="with-childs {if $SELECTED_MENU_CATEGORY eq $APP_NAME}active{/if}"> 
                <a class="has-arrow waves-effect waves-dark " >
                  <i class="app-icon-list material-icons" >{$iconsarray[{strtolower($APP_NAME)}]}
                  </i>
                  <span class="hide-menu">{vtranslate("LBL_$APP_NAME")}
                  </span>
                </a>
              ...
              {/if}
              {/foreach}
              <li class="nav-small-cap hide">TOOLS & SETTINGS
              </li>
              {foreach item=APP_MENU_MODEL from=$APP_GROUPED_MENU.$APP_NAME}
              {assign var=FIRST_MENU_MODEL value=$APP_MENU_MODEL}
              {if $APP_MENU_MODEL}
              ...
              <li class="with-childs {if $SELECTED_MENU_CATEGORY eq $APP_NAME}active{/if}"> 
                <a class="has-arrow waves-effect waves-dark ">
                  <i class="app-icon-list material-icons">more
                  </i>
                  <span class="hide-menu"> {vtranslate("LBL_MORE")}
                  </span>
                </a>
                <ul style="padding-left:6px;padding-top:10px;" >
                  ...
                  <li>
                    <a class="waves-effect waves-dark {if $MODULE eq $moduleName}active{/if}" href="index.php?module=Rss&view=List" >
                      ...
                      <span class="hide-menu"> {vtranslate($RSS_MODULE_MODEL->getName(), $RSS_MODULE_MODEL->getName())}
                      </span>
                    </a>
                  </li>
                  {/if}
                  ...
                  <li>
                    <a class="waves-effect waves-dark {if $MODULE eq $moduleName}active{/if} " href="index.php?module=Portal&view=List">
                      <i class="material-icons module-icon">web
                      </i> 
                      <span class="hide-menu"> {vtranslate('Portal')}
                      </span>
                    </a>
                  </li>
                  {/if}
                  ...
                  <li>
                    <a class="waves-effect waves-dark {if $MODULE eq $moduleName}active{/if} " href="index.php?module=Bills&view=List">
                      <i class="material-icons module-icon">receipt
                      </i> 
                      <span class="hide-menu"> {vtranslate('Office Bills','Vtiger')}
                      </span>
                    </a>
                  </li>
                  {/if}
                  ...
                  <li>
                    <a class="waves-effect waves-dark {if $MODULE eq $moduleName}active{/if} " href="index.php?module=Payments&view=List">
                      <i class="material-icons module-icon">payment
                      </i> 
                      <span class="hide-menu"> {vtranslate('Payments')}
                      </span>
                    </a>
                  </li>
                  {/if}
          ...
          <ul class="nav navbar-nav newtabs pull-right">
                  ...
                  <ul class="dropdownlist">
                    <li>
                      <a class="dropdown-icon-dashboard"  title="Employee" href="index.php?module=Users&view=List&block=15&fieldid=53&parent=Settings">
                        <i class="material-icons module-icon">person
                        </i>&nbsp;Employee
                      </a>
                    </li>
                    ...
                    <li>
                      <a class="dropdown-icon-dashboard"   title="Leave" href="index.php?module=Leave&view=List">
                        <i class="material-icons module-icon">exit_to_app
                        </i>&nbsp;Leave
                      </a>
                    </li>                                                                         
                    {else}
                    ...
                    <li admin="" moudel="Timesheet">
                      <a  class="dropdown-icon-dashboard"   href="index.php?module=Timesheet&amp;view=List&amp;app=ADMIN ">
                        <i class="material-icons module-icon">timer
                        </i>
                        <span class="hide-menu"> {vtranslate('Timesheet','Home')}
                        </span>
                      </a>
                    </li>*}
                    {if $USER_MODEL->column_fields['roleid'] eq 'H12' || $USER_MODEL->isAdminUser()}  
                    <li>
                      <a class="dropdown-icon-dashboard" title="Claim" href="index.php?module=Claim&view=List">
                        <i class="material-icons module-icon">attach_money
                        </i>&nbsp;Claim
                      </a>
                    </li>
                    {else}
                    ...
                    <li>
                      <a class="dropdown-icon-dashboard"  title="Performance" href="index.php?module=Performance&view=List&amp;block=15&amp;fieldid=56">
                        <i class="material-icons module-icon">timeline
                        </i>&nbsp;Performance
                        </li>*}
                  </ul>
                </div>
            ...
            <li>
              <div class="dropdownSales">
                <div class="addtionalDashboardTab"  style="padding: 10px 10px;">
                  <span aria-hidden="true">Sales
                  </span> 
                  <i class="fa fa-lock" style="color: #2f5597;vertical-align: middle;font-size: 13px;">
                  </i>
                </div>
                <div class="dropdown-content-Sales">
                  ...
                  <div class="col-md-12 row" style="padding: 10px;">
                    <a href="http://dev7.secondcrm.com/agiliux/addons.php" class="buttonpopup">Read More
                    </a>
                  </div>
                </div>
              </div>
            ...
            <li>
              <div class="dropdownTools">
                <div class="addtionalDashboardTab"  style="padding: 10px 10px;">
                  <span aria-hidden="true">Communications
                  </span>
                </div>
            ...
            <ul class="nav navbar-nav">
              <li class='searchoption'>
                ...
                <select class="select2 col-lg-12" id="searchModuleList" data-placeholder="{vtranslate('LBL_SELECT_MODULE')}">
                  ...
                  <option value="{$MODULE_NAME}" {if $MODULE_NAME eq $SOURCE_MODULE}selected="selected"{/if}>{vtranslate($MODULE_NAME,$MODULE_NAME)}
                  </option>
                  {/foreach}
                </select>
                &nbsp;&nbsp;&nbsp;
              ...
              <li style="width: 200px;">
                <div class="search-links-container hidden-sm">
                  <div class="search-link hidden-xs" style="    border: 1px solid #000;color: #000!important;">
                    <span class="ti-search" aria-hidden="true" style="color: #000 !important;">
                    </span>
                    <input class="keyword-input" id="search-top-bar" type="text" placeholder="{vtranslate('LBL_TYPE_SEARCH')}" value="{$GLOBAL_SEARCH_VALUE}">
                    <span id="adv-search" title="Advanced Search" class="adv-search ti-arrow-circle-down pull-right cursorPointer" aria-hidden="true" >
                    </span>
                  </div>
                </div>
              </li>
              ...
              <li>
                ...
                <div class="dropdown ">
                  <div class="dropdown-toggle" data-toggle="dropdown" aria-expanded="true">
                    <a aria-hidden="true" href="#" id="menubar_quickCreate" class="qc-button rightside-icon-dashboard" title="Quick Create">
                      <i class="fa fa-plus">
                      </i>
                    </a>
                  </div>
                ...
                <div class="dropdown">
                  ...
                  <ul class="dropdown-menu animated fadeIn" role="menu" aria-labelledby="dropdownMenu1" style="width:650px;">
                    <li class="title" style="padding: 5px 0 0 15px;">
                      <h4>
                        <strong>{vtranslate('LBL_QUICK_CREATE',$MODULE)}
                        </strong>
                      </h4>
                    </li>
                    <hr/>
                        ...
                        <div class="row">
                          ...
                          <div {$moduleName} class="{if $hideDiv}create_restricted_{$moduleModel->getName()} hide{else}col-lg-4{/if}">
                            <a id="menubar_quickCreate_Events" class="quickCreateModule" data-name="Events"
                              ...
                              <span class="quick-create-module">{vtranslate('LBL_EVENT',$moduleName)}
                              </span>
                            </a>
                          </div>
                          {if $count % 3 == 2}
                        ...
                        <div class="row">
                          ...
                          <div {$moduleName} class="{if $hideDiv}create_restricted_{$moduleModel->getName()} hide{else}col-lg-4{/if}">
                            <a id="menubar_quickCreate_{$moduleModel->getName()}" class="quickCreateModule" 
                              ...
                              <span class="quick-create-module">{vtranslate($singularLabel,$moduleName)}
                              </span>
                            </a>
                          </div>
                          {if !$hideDiv}
                          ...
                          <div {$moduleName} class="{if $hideDiv}create_restricted_{$moduleModel->getName()} hide{else}col-lg-4{/if} dropdown">
                            <a id="menubar_quickCreate_{$moduleModel->getName()}" class="quickCreateModuleSubmenu dropdown-toggle" data-name="{$moduleModel->getName()}" data-toggle="dropdown" 
                              ...
                              <i class="material-icons pull-left">{$iconsarray[{strtolower($moduleName)}]}
                              </i>
                            ...
                            <ul class="dropdown-menu quickcreateMoreDropdown" aria-labelledby="menubar_quickCreate_{$moduleModel->getName()}">
                              <li class="dropdown-header">
                                <i class="material-icons">file_upload
                                </i> {vtranslate('LBL_FILE_UPLOAD', $moduleName)}
                              </li>
                              <li id="VtigerAction">
                                <a href="javascript:Documents_Index_Js.uploadTo('Vtiger')">
                              ...
                              <li class="dropdown-header">
                                <i class="ti-link">
                                </i> {vtranslate('LBL_LINK_EXTERNAL_DOCUMENT', $moduleName)}
                              </li>
                              <li id="shareDocument">
                                <a href="javascript:Documents_Index_Js.createDocument('E')">&nbsp;
                                  <i class="material-icons">link
                                  </i>&nbsp;&nbsp; {vtranslate('LBL_FROM_SERVICE', $moduleName, {vtranslate('LBL_FILE_URL', $moduleName)})}
                                </a>
                              </li>
                              <li role="separator" class="divider">
                              </li>
                              <li id="createDocument">
                                <a href="javascript:Documents_Index_Js.createDocument('W')">
                                  <i class="ti-file">
                                  </i> {vtranslate('LBL_CREATE_NEW', $moduleName, {vtranslate('SINGLE_Documents', $moduleName)})}
                                </a>
                              </li>
                            </ul>
                          </div>
                          ...
                          <div class="col-lg-12">
                            <div class="col-lg-4">
                              <a id="menubar_quickCreate_Users" class="quickCreateModule" data-name="Users"
                                ...
                                <span class="quick-create-module">{vtranslate('Users','Users')}
                                </span>
                              </a>
                            </div>
                            <div class="col-lg-4">
                              <a id="menubar_quickCreate_Users" class="quickCreateModule" data-name="Users"
                                ...
                                <span class="quick-create-module">{vtranslate('Leave','Leave')}
                                </span>
                              </a>
                            </div>
                            <div class="col-lg-4">
                              <a id="menubar_quickCreate_Users" class="quickCreateModule" data-name="Users"
                                ...
                                <span class="quick-create-module">{vtranslate('Bills','Bills')}
                                </span>
                              </a>
                            </div>
                          </div>
              ...
              <li>
                <div>
                  ...
                  <ul class="hide notification-list list-unstyled" onmouseleave="Vtiger_Header_Js.hideNotification()">
                    <li>
                      <h6 class="text-left notifications-heading">Notifications
                        <i class="fa fa-gear pull-right">
                        </i>
                      </h6>
                    </li>
                    <li>
                      <div class="notification-container unread">
                        <div class="img-holder">
                          <img src="" class="img-circle" height="30" width="30">
                        </div>
                        <div class="notification-title">
                          <a>
                            <strong>Khaled approved leave
                            </strong>
                          </a>  
                          <span class="notification-time">2 hr
                          </span> 
                        </div> 
                      </div>
                      <div class="clearfix">
...
<i class="material-icons">card_travel</i></a></div></li>-->
              ...
              <li class="dropdown">
                <div>
                  ...
                  <a href="#" class="userName dropdown-toggle " data-toggle="dropdown" role="button" title="{$USER_MODEL->get('first_name')} {$USER_MODEL->get('last_name')}
                    ...
                    <span class="link-text-xs-only hidden-lg hidden-md hidden-sm">{$USER_MODEL->getName()}
                    </span>
                  </a>
                  {else}
                    ...
                    <div class="row">
                      <div class="col-lg-12 col-sm-12" style="padding:10px;">
                        ...
                        <div class="col-lg-12 col-sm-12">
                          <h5 class=" text-center user-first-n-last-name text-bold">{$USER_MODEL->get('first_name')} {$USER_MODEL->get('last_name')}
                          </h5>
                          <h6 class="textOverflowEllipsis text-center" title='{$USER_MODEL->get('user_name')}'>{$USER_MODEL->get('user_name')} | {$USER_MODEL->getUserRoleName()}
                          </h6>
                          {assign var=useremail value=$USER_MODEL->get('email1')}
                          <h6 class="textOverflowEllipsis text-center" title='{$USER_MODEL->get('email')}'>{$useremail}
                          </h6>
                        </div>
                          ...
                          <ul class="dropdown-user list-inline ">
                            ...
                            <li>
                              <a id="menubar_item_right_LBL_MY_PREFERENCES" class="btn btn-primary" href="{$USER_MODEL->getPreferenceDetailViewUrl()}">
                                <i class="material-icons">settings
                                </i> {vtranslate('LBL_MY_PREFERENCES')}
                              </a>
                            </li>
                            <li role="separator" class="divider">
                            </li>
                        ...
                        <div class="col-md-3">Colors
                        </div>
                        <div class="col-md-9">
                          <ul class="color-list list-inline pull-right">
                            <li>
                              <a class="btn color-box color-blue themeElement" data-skinName="blue">
                                <i class="fa {if $USER_MODEL->get('theme') eq 'blue'}  fa-check {/if}"  >
                                </i>
                              </a>
                            </li>
                            <li>
                              <a class="btn color-box color-purple themeElement" data-skinName="purple">
                                <i class="fa {if $USER_MODEL->get('theme') eq 'purple'} fa-check  {/if}">
                                </i>
                              </a>
                            </li>
                            <li>
                              <a class="btn color-box color-yellow themeElement" data-skinName="yellow">
                                <i class="fa  {if $USER_MODEL->get('theme') eq 'yellow'} fa-check {/if}">
                                </i>
                              </a>
                            </li>
                            <li>
                              <a class="btn color-box color-green themeElement" data-skinName="green">
                                <i class="fa {if $USER_MODEL->get('theme') eq 'green'}  fa-check  {/if}">
                                </i>
                              </a>
                            </li>
                            <li>
                              <a class="btn color-box color-shipcove themeElement" data-skinName="shipcove">
                                <i class="fa {if $USER_MODEL->get('theme') eq 'shipcove'}  fa-check  {/if}">
                                </i>
                              </a>
                            </li>
                            <li>
                              <a class="btn color-box color-lilacbush themeElement" data-skinName="lilacbush">
                                <i class="fa {if $USER_MODEL->get('theme') eq 'lilacbush'}  fa-check  {/if}">
                                </i>
                              </a>
                            </li>
                            <li>
                              <a class="btn color-box color-energyyellow themeElement" data-skinName="energyyellow">
                                <i class="fa {if $USER_MODEL->get('theme') eq 'energyyellow'}  fa-check  {/if}">
                                </i>
                              </a>
                            </li>
                            <li>
                              <a class="btn color-box color-downy themeElement" data-skinName="downy">
                                <i class="fa {if $USER_MODEL->get('theme') eq 'downy'}  fa-check  {/if}">
                                </i>
                              </a>
                            </li>
                            <li>
                              <a class="btn color-box color-lily themeElement" data-skinName="lily">
                                <i class="fa {if $USER_MODEL->get('theme') eq 'lily'}  fa-check  {/if}">
                                </i>
                              </a>
                            </li>
                            <li>
                              <a class="btn color-box color-danube themeElement" data-skinName="danube">
                                <i class="fa {if $USER_MODEL->get('theme') eq 'danube'}  fa-check  {/if}">
                                </i>
                              </a>
                            </li>
                            <li>
                              <a class="btn color-box color-selectiveyellow themeElement" data-skinName="selectiveyellow">
                                <i class="fa {if $USER_MODEL->get('theme') eq 'selectiveyellow'}  fa-check  {/if}">
                                </i>
                              </a>
                            </li>
                            <li>
                              <a class="btn color-box color-sandybrown themeElement" data-skinName="sandybrown">
                                <i class="fa {if $USER_MODEL->get('theme') eq 'sandybrown'}  fa-check  {/if}">
                                </i>
                              </a>
                            </li>
                            <li>
                              <a class="btn color-box color-mandy themeElement" data-skinName="mandy">
                                <i class="fa {if $USER_MODEL->get('theme') eq 'mandy'}  fa-check  {/if}">
                                </i>
                              </a>
                            </li>
                            <li>
                              <a class="btn color-box color-aquaisland themeElement" data-skinName="aquaisland">
                                <i class="fa {if $USER_MODEL->get('theme') eq 'aquaisland'}  fa-check  {/if}">
                                </i>
                              </a>
                            </li>
                          </ul>
                        ...
                        <div class="col-md-12 col-sm-12">
                          ...
                          <div class="dark-theme">
                            <strong class="pull-left" style="padding-top:6px; margin-right: 10px;"> Dark Theme
                            </strong>
                            <!-- Rounded switch -->
                        ...
                        <div class="col-md-12">
                          <ul class="profile-list list-unstyled">
                            <li> 
                              <a class="" href="index.php?module=Users&parent=Settings&view=Calendar&record={$USER_MODEL->get('id') }">
                                <i class='fa fa-gear'>
                                </i>  Preferences 
                              </a>
                            </li>
                            <li> 
                              <a class="" href="index.php?module=Home&view=DashBoard&tabid=1298">
                                <i class='fa fa-rocket'>
                                </i> Getting Started
                              </a>
                            </li>
                            <li> 
                              <a class="" href="http://dev7.secondcrm.com/agiliux/help.php">
          ...
          <div class="col-xs-4 visible-xs padding0px">
            ...
            <div class="dropdown btn-group pull-right">
              <button style="background-color: #398bf7;padding: 12px;color: #fff;margin-top: -1px;margin-bottom:0px;border: none;border-right: 1px solid #fff; " class="btn dropdown-toggle" type="button" data-toggle="dropdown">
                <i class="material-icons">settings
                </i>
                &nbsp;
                <span class="caret">
              ...
              <ul class="dropdown-menu">
                ...
                <li>
                  <a href="index.php?module=Calendar&view={$CALENDAR_MODULE_MODEL->getDefaultViewName()}" title="{vtranslate('Calendar','Calendar')}" aria-hidden="true">
                    ...
                    </i>&nbsp;{vtranslate('Calendar','Calendar')}
                  </a>
                </li>
                {/if}
                {if $USER_PRIVILEGES_MODEL->hasModulePermission($CALENDAR_MODULE_MODEL->getId())}
                <li>
                  <a class="taskManagement" href="#" title="{vtranslate('Task','Task')}" aria-hidden="true">
                    <i class="material-icons">card_travel
                    </i>&nbsp;{vtranslate('Task','Task')}
                  </a>
                </li>
                {/if}
                {assign var=REPORTS_MODULE_MODEL value=Vtiger_Module_Model::getInstance('Reports')}
                  ...
                  <ul class="faskfirst">
                    ...
                    <li class="{if $MODULE eq "MailManager"}active{/if}"> 
                      <a class=" waves-effect waves-dark" href="index.php?module=MailManager&view=List" >
                        <i class="app-icon-list material-icons">email
                        </i>
                        <span class="hide-menu"> {vtranslate('MailManager')}
                        </span>
                      </a>
                    </li>*}
                    {/if}
