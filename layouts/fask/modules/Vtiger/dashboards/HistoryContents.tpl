                                ...
                                <div class="row entry clearfix">
                                        <div class='col-lg-1 col-xs-3 pull-left'>
                                                ...
                                                {assign var=iconsarray value=['potentials'=>'attach_money','education'=>'book','claim'=>'attach_money','marketing'=>'thumb_up','leads'=>'thumb_up','accounts'=>'business',
                                                                ...
                                                                'mycthemeswitcher'=>'folder','training'=>'book','message'=>'sms','contacts'=>'contacts','payslip'=>'receipt','performance'=>'timeline','passportvisa'=>'visa','workinghours'=>'access_time','messageboard '=>'sms','board'=>'sms','holiday'=>'cloud','claimtype'=>'attach_money', 'chat'=>'chat', 'mobilecall'=>'call', 'call'=>'call', 'meeting'=>'people' ,'task'=>'card_travel','leave'=>'exit_to_app','employeecontract'=>'person']}


                                                    {*<span><i class="material-icons entryIcon" title={$TRANSLATED_MODULE_NAME}>{$iconsarray[{strtolower($VT_ICON)}]}</i></span>&nbsp;&nbsp;*}
                                                                       <i class="material-icons entryIcon" modle='{$TRANSLATED_MODULE_NAME}' title={$TRANSLATED_MODULE_NAME}>{$iconsarray[{strtolower($VT_ICON)}]}</i> &nbsp;&nbsp;
