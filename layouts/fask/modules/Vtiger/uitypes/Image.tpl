                        ...
                        <div class="row" style="margin-top:5px;">
                                {if !empty($IMAGE_INFO.path) && !empty({$IMAGE_INFO.orgname})}
                                        ...
                                        <span class="col-lg-5">
                                             ...
                                             <span class="col-lg-1">
                                                 <input type="button" id="file_{$ITER}" value="{vtranslate('LBL_DELETE','Vtiger')}" class="imageDelete btn btn-danger" {if $MODULE eq 'Users'} style='position: absolute;top: -58.6px;   left: -2393%;'{/if}> 
                                             </span>
