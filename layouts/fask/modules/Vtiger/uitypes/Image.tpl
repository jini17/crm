                                ...
                                {if !empty($IMAGE_INFO.path) && !empty({$IMAGE_INFO.orgname})}
                                        ...
                                        <span class="col-lg-5">
                                                <span class="row">
                                                        ...
                                                        <span class="col-lg-1"><input type="button" id="file_{$ITER}" value="{vtranslate('LBL_DELETE','Vtiger')}" class="imageDelete btn btn-danger" {if $MODULE eq 'Users'} style='position: absolute;top: -79px;   left: -972%;'{/if}> </span>
                                                </span>
                                        </span>
                                {/if}
                        </div>
