                ...
                jQuery('.main-container').on('click', '.essentials-toggle', function() {
                        ...
                        if(jQuery('.sidebar-essentials').hasClass('hide')) {
                                ...
                                jQuery('.essentials-toggle-marker').removeClass('fa-chevron-left')
                                                ...
                                                jQuery('.essentials-toggle').css('right','0 !important');
                        }
...
//                         app.helper.hideProgress();
        ...
        addBodyScroll: function () {
                ...
                var minHeight = $(document).height() - 92;
...
$(function(){
        ...
        $('.app-trigger, .app-icon, .app-navigator').on('click',function(e){
                ...
                if($("#sidebarnav").hasClass("mini-sidebar")){
                        mycOpenLeftSidebar();
                        $(".main-container, .dashBoardContainer").addClass("blurredContent");
                        $(".module-action-bar").addClass("hide");
                }
                else{
                        mycCloseLeftSidebar();
                        $(".main-container, .dashBoardContainer").removeClass("blurredContent");
...
function mycCloseLeftSidebar(){
        ...
        else $(".left-sidebar").css("width","80px");
        //$("#page, .app-fixed-navbar").css("margin-left","80px");
        $(".with-childs").find("ul").css("padding-left","5px");
        $("#appnavigator").css("position","relative");
        $("#appnavigator").css("left","5px");
