     ...
     //Added By jitu@secondcrm.com on 29-10-2014
        ...
        registerEvents: function () {
                ...
                if(defaultTab =='leave'){
                 ...
                 else if(defaultTab =='ListClaim'){             
                     jQuery("a[href='#claim']").closest("li").addClass('active');
                        this.registerClaimList()
                     //   this.registerClaimApproveTrigger(claimid, appid);
                }	
                else if(defaultTab =='ListLeave'){             
                     jQuery("a[href='#leave']").closest("li").addClass('active');
                        this.registerLeaveList()
                     //   this.registerClaimApproveTrigger(claimid, appid);
                }	
