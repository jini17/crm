...
function initAutocomplete() {
    ...
    autocompletepikcup = new google.maps.places.Autocomplete(
            /** @type {!HTMLInputElement} */(document.getElementById('Users_editView_fieldName_address_city')),
           { types: ['(cities)'] });
...
function fillInAddresspickup() {
    ...
    for (var i = 0; i < place.address_components.length; i++) {
        ...
        if (addressType == 'administrative_area_level_1') {
            ...
            document.getElementById('Users_editView_fieldName_address_state').value = val;
        }
        /************* Country ***************************/
        if (addressType == 'country') {
            var val = place.address_components[i][componentForm[addressType]];
            document.getElementById('Users_editView_fieldName_address_country').value = val;
        }
        /*********** City**************/
        if(addressType == 'locality'){
            ...
            document.getElementById('Users_editView_fieldName_address_city').value = val;
        }
    }
}
