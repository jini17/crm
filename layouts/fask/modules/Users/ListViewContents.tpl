                                                ...
                                                <tr class="listViewEntries" data-id='{$LISTVIEW_ENTRY->getId()}' data-recordUrl='{$LISTVIEW_ENTRY->getDetailViewUrl()}&parentblock=LBL_USER_MANAGEMENT' id="{$MODULE}_listView_row_{$smarty.foreach.listview.index+1}">
                                                        ...
                                                        <td style='width:300px;'>    
                                                            <div class='user-social text-center'>
                                                                <a class='facebook' href="#" style="margin-left:5px;"><i class='fa fa-facebook'></i></a>
                                                                <a class='twitter' href="#" style="margin-left:5px;"><i class='fa fa-twitter'></i></a>
                                                                <a  class='linkedin' href="#" style="margin-left:5px;"><i class='fa fa-linkedin'></i></a>
