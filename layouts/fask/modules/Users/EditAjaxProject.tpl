                                ...
                                <div class="form-group" style="margin-bottom: 0px !important;">
                                        <div class="col-md-12" style="margin-bottom: 15px;">
                                                ...
                                                <div class="controls date col-md-8">
                                                         <textarea style="width:350px!important" data-rule-required = "true"  id="description" name="description" class="span11"  maxlength="300">{$PROJECT_DETAIL['description']}</textarea>
                                                </div>
                                        </div>	
                                        <div class="col-md-12" style="margin-bottom: 15px;">
                                                <div class="col-md-4">
