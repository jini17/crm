	                ...
	                <div class="form-group" style="margin-bottom: 0px !important;">
	                	<div class="col-md-12" style="margin-bottom: 15px;">
							...
							<div class="controls fieldValue col-md-8">
								 <input id="title" class="fieldValue" data-rule-required = "true" type="text" value="{$PROJECT_DETAIL['title']}" name="title">
							</div>
						</div>
					</div>
			<!--end-->
				...
				<div class="form-group" style="margin-bottom: 0px !important;">
					<div class="col-md-12" style="margin-bottom: 15px;">
						...
						<div class="controls col-md-8">
						  	<select class="select2" name="designation" id="designation" onchange="updateSelectBox('designation','designationtxt');" data-rule-required = "true">	
						...
						<div class="col-md-12" style="margin-bottom: 15px;">
							...
							<div class="controls fieldValue col-md-8" align="right">
								<span class="hide" id="designationtxt">
									<input style="width:100%;" type="text" name="designation_titletxt" id="designation_titletxt	" data-rule-required = "true" />
								</span>
							</div>
						</div>
					</div>
				...
				<div class="form-group" style="margin-bottom: 0px !important;">
					<div class="col-md-12" style="margin-bottom: 15px;">
						...
						<div class="controls date col-md-8">
							<input id="project_url" class="fieldValue" type="text" value="{$PROJECT_DETAIL['project_url']}" name="project_url" data-rule-required = "true" >
						</div>		
					</div>
				</div>		 	
				<div class="form-group" style="margin-bottom: 0px !important;">
					<div class="col-md-12" style="margin-bottom: 15px;">
						...
						<div class="controls date col-md-8">
							<input type="checkbox" name="chkviewable" id="chkviewable" {if $PROJECT_DETAIL.isview eq 1} checked {/if}>
						</div>
					</div>
				</div>
			</div>
