			...
			<!--end-->
					...
					<div class="col-md-12" style="margin-bottom: 15px;">
						...
						<div class="controls fieldValue col-md-8" align="right">
							<span class="hide" id="areaofstudytxt">
								<input style="width:100%;" type="text" name="majortxt" id="majortxt" data-rule-required = "true"/>
							</span>
						</div>
					</div>		
				</div>
				...
				<div class="form-group" style="margin-bottom: 0px !important;">
					<div class="col-md-12" style="margin-bottom: 15px;">
						...
						<div class="controls date col-md-8">
							<input type="checkbox" name="chkviewable" id="chkviewable" {if $EDUCATION_DETAIL.public eq 1} checked {/if}>
						</div>	
					</div>
				</div>
			</div>
