 ...
 <div class="leaveModalContainer modal-dialog modal-xs modelContainer">
	...
	<form id="editLeave" name="editLeave" class="form-horizontal" method="POST">
		...
		<div class="modal-body">
			...
			<div class="control-group">
				<label class="control-label">
					<span class="redColor">*</span>&nbsp;{vtranslate('LBL_LEAVE_TYPE', $QUALIFIED_MODULE)}
				</label>
		...
		<!--end-->
			<div class="control-group">
				...
				<div class="controls date">
					<input id="start_date" type="text" class="dateField" type="text" value="{$LEAVE_DETAIL.from_date}" data-fieldinfo= '{Vtiger_Util_Helper::toSafeHTML(ZEND_JSON::encode($STARTDATEFIELD))}' data-validation-engine="validate[required, funcCall[Vtiger_Base_Validator_Js.invokeValidation]]" name="start_date" data-date-format="dd-mm-yyyy">	
			...
			<div class="control-group" id="enddate_div">
				<label class="control-label"><span class="redColor">*</span>&nbsp;{vtranslate('LBL_END_DATE', $QUALIFIED_MODULE)}</label>
			...
			<div class="control-group">
				<label class="control-label">&nbsp;{vtranslate('LBL_REPLACE_USER', $QUALIFIED_MODULE)}</label>		
					<div class="controls">
					<select class="select2" name="replaceuser" id="replaceuser" data-validation-engine="validate[required]">
			...
			<div class="control-group">
				<label class="control-label"><span class="redColor">*</span>&nbsp;{vtranslate('LBL_REASON', $QUALIFIED_MODULE)}</label>		
				<div class="controls">
		...
		{if $MANAGER eq 'true'}
			<div class="control-group">
				<!--approved start-->
				<label class="control-label">&nbsp;{vtranslate('LBL_APPROVED', $QUALIFIED_MODULE)}</label>
