...
<div class="input-group">
	...
	value="{if $MODULE eq 'Claim'}{$FIELD_MODEL->get('fieldvalue')}{else }{$FIELD_MODEL->getEditViewDisplayValue($FIELD_MODEL->get('fieldvalue'))}{/if}" {if !empty($SPECIAL_VALIDATOR)}data-validator='{Zend_Json::encode($SPECIAL_VALIDATOR)}'{/if}
