			...
			<div class="block">
				...
				<table class="table detailview-table no-border">
					<tbody> 
						...
						<!--ADDED BY MABRUK FOR SMS NOTIFIER-->
						<tr>
							<td class="fieldLabel {$WIDTHTYPE}"><label class="muted marginRight10px">Template Type</label></td>
							<td class="fieldValue {$WIDTHTYPE}">{$RECORD->get('templatetype')}</td>
						</tr>
						<!--END-->
						<tr>
