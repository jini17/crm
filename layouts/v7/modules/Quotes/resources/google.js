...
function initAutocomplete() {
    ...
    autocompletepikcup = new google.maps.places.Autocomplete(
            /** @type {!HTMLInputElement} */(document.getElementById('Quotes_editView_fieldName_bill_city')),
           { types: ['(cities)'] });
            //console.log("After Autocomplete Pickup Assignment");

               autocompletedispatch = new google.maps.places.Autocomplete(
            /** @type {!HTMLInputElement} */(document.getElementById('Quotes_editView_fieldName_ship_city')),
            { types: ['(cities)'] });
           //{types: ['geocode']});
...
function fillInAddresspickup() {
    ...
    for (var i = 0; i < place.address_components.length; i++) {
        ...
        if (addressType == 'administrative_area_level_1') {
            ...
            document.getElementById('Quotes_editView_fieldName_bill_state').value = val;
        }
        /************* Country ***************************/
        if (addressType == 'country') {
            var val = place.address_components[i][componentForm[addressType]];
            document.getElementById('Quotes_editView_fieldName_bill_country').value = val;
        }
        /*********** City**************/
        if(addressType == 'locality'){
            ...
            document.getElementById('Quotes_editView_fieldName_bill_city').value = val;
        }
    }
}
...
function fillInAddressdispatch() {
    ...
    for (var i = 0; i < place.address_components.length; i++) {
        ...
        if (addressType == 'administrative_area_level_1') {
            var val = place.address_components[i][componentForm[addressType]];
            document.getElementById('Quotes_editView_fieldName_ship_state').value = val;
        }
        /************* Country ***************************/
        if (addressType == 'country') {
            var val = place.address_components[i][componentForm[addressType]];
            document.getElementById('Quotes_editView_fieldName_ship_country').value = val;
        }
        /*********** City**************/
        if(addressType == 'locality'){
             var val = place.address_components[i][componentForm[addressType]];
            ...
            document.getElementById('Quotes_editView_fieldName_ship_city').value = val;
        }
