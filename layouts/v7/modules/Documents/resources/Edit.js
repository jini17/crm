...
Vtiger_Edit_Js("Documents_Edit_Js", {
    ...
    GOOGLE_DRIVE_FILE_LOCATION_TYPE : 'G', //Added By Mabruk 
    ...
    //Added By Mabruk 
    isFileLocationGoogleDriveType : function(fileLocationElement) {
        if(fileLocationElement.val() == this.GOOGLE_DRIVE_FILE_LOCATION_TYPE) {
            return true;
        }
        return false;
    },
