...
-->*}
{strip}
<div class="modal-dialog modal-lg office365Settings" style="min-width: 800px;">
    <div class="modal-content" >
        ...
        <form class="form-horizontal" name="contactsyncsettings">
            ...
            <div class="modal-body">
                ...
                <div id="office365syncfieldmapping" style="margin:15px;">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <select class="select2 office365-type col-sm-5" data-category="email">
                                    ...
                                    <input type="text" class="office365-custom-label inputElement" style="visibility:{if $FIELD_MAPPING[$FLDNAME]['office365_field_type'] neq 'custom'}hidden{else}visible{/if};width:40%;" 
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <select class="select2 stretched office365-type col-sm-5" data-category="phone">
                                        {foreach item=TYPE from=$OFFICE365_TYPES}
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <select class="select2 stretched office365-type col-sm-5" data-category="address">
                                        {foreach item=TYPE from=$OFFICE365_TYPES}
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        {if $CUSTOM_FIELD_MAP['office365_field_name'] eq 'gd:email'}
                                            ...
                                            <input type="text" class="office365-custom-label inputElement" style="visibility:{if $CUSTOM_FIELD_MAP['office365_field_type'] neq 'custom'}hidden{else}visible{/if};width:40%;" 
                                                   value="{if $CUSTOM_FIELD_MAP['office365_field_type'] eq 'custom'}{$CUSTOM_FIELD_MAP['office365_custom_label']}{/if}" data-rule-required="true"/>
                                        {else if $CUSTOM_FIELD_MAP['office365_field_name'] eq 'gd:phoneNumber'}
                                            {assign var=OFFICE365_TYPES value=$OFFICE365_FIELDS['phone']['types']}
                                            <select class="select2 office365-type col-sm-5" data-category="phone">
                                                {foreach item=TYPE from=$OFFICE365_TYPES}
                                        ...
                                        {else if $CUSTOM_FIELD_MAP['office365_field_name'] eq 'gContact:userDefinedField'}
                                            ...
                                            <input type="text" class="office365-custom-label inputElement" value="{$CUSTOM_FIELD_MAP['office365_custom_label']}" style="width:40%;" data-rule-required="true"/>
                                        {else if $CUSTOM_FIELD_MAP['office365_field_name'] eq 'gContact:website'}
                                            {assign var=OFFICE365_TYPES value=$OFFICE365_FIELDS['url']['types']}
                                            <select class="select2 office365-type col-sm-5" data-category="url">
                                                {foreach item=TYPE from=$OFFICE365_TYPES}
