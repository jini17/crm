...
Vtiger.Class("Office365_Settings_Js", {
    ...
    registerSettingsEventsForContacts : function(container) {
        ...
        this.registerOffice365TypeChangeEvent(container);
    ...
    registerAddCustomFieldMappingEvent : function(container) {
        ...
        jQuery('.addCustomFieldMapping',container).on('click',function(e) {
            ...
            thisInstance.registerOffice365TypeChangeEvent(container,lastRow.find('select.google-type'));
    ...
    registerOffice365TypeChangeEvent : function(container,selectElement) {
        var thisInstance = this;
